...
val defaultChannelConfig: ChannelConfig = channelConfigOf(packageName, packageName, NotificationUtils.IMPORTANCE_DEFAULT)

inline val areNotificationsEnabled: Boolean get() = NotificationUtils.areNotificationsEnabled()

inline fun notify(
  id: Int, tag: String? = null, channelConfig: ChannelConfig = defaultChannelConfig, noinline block: NotificationCompat.Builder.() -> Unit
) =
