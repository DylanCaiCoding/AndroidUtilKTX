...
inline fun Bitmap.scale(newWidth: Int, newHeight: Int, recycle: Boolean = false): Bitmap =
  ImageUtils.scale(this, newWidth, newHeight, recycle)

inline fun Bitmap.scale(scaleWidth: Float, scaleHeight: Float, recycle: Boolean = false): Bitmap =
  ImageUtils.scale(this, scaleWidth, scaleHeight, recycle)

inline fun Bitmap.clip(x: Int, y: Int, width: Int, height: Int, recycle: Boolean = false): Bitmap =
  ImageUtils.clip(this, x, y, width, height, recycle)

inline fun Bitmap.skew(kx: Float, ky: Float, recycle: Boolean = false): Bitmap =
  ImageUtils.skew(this, kx, ky, recycle)

inline fun Bitmap.skew(kx: Float, ky: Float, px: Float, py: Float, recycle: Boolean = false): Bitmap =
  ImageUtils.skew(this, kx, ky, px, py, recycle)

inline fun Bitmap.rotate(degree: Int, px: Float, py: Float, recycle: Boolean = false): Bitmap =
  ImageUtils.rotate(this, degree, px, py, recycle)

inline val File.imageRotateDegree: Int get() = ImageUtils.getRotateDegree(path)

inline fun Bitmap.setRound(@IntRange(from = 0) borderSize: Int = 0, @ColorInt borderColor: Int = 0, recycle: Boolean = false): Bitmap =
...
inline fun Bitmap.toAlpha(recycle: Boolean = false): Bitmap = ImageUtils.toAlpha(this, recycle)

inline fun Bitmap.toGray(recycle: Boolean = false): Bitmap = ImageUtils.toGray(this, recycle)
...
inline fun Bitmap.compressByScale(scaleWidth: Float, scaleHeight: Float, recycle: Boolean = false): Bitmap =
  ImageUtils.compressByScale(this, scaleWidth, scaleHeight, recycle)

inline fun Bitmap.compressByScale(newWidth: Int, newHeight: Int, recycle: Boolean = false): Bitmap =
  ImageUtils.compressByScale(this, newWidth, newHeight, recycle)

inline fun Bitmap.compressByQuality(maxByteSize: Long, recycle: Boolean = false): ByteArray =
  ImageUtils.compressByQuality(this, maxByteSize, recycle)

inline fun Bitmap.compressByQuality(@IntRange(from = 0, to = 100) quality: Int, recycle: Boolean = false): ByteArray =
  ImageUtils.compressByQuality(this, quality, recycle)

inline fun Bitmap.compressByScale(simpleSize: Int, recycle: Boolean = false): Bitmap =
  ImageUtils.compressBySampleSize(this, simpleSize, recycle)

inline fun Bitmap.compressBySampleSize(maxWidth: Int, maxHeight: Int, recycle: Boolean = false): Bitmap =
